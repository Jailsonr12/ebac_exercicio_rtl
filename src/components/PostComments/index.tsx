...
const Post = () => {
    ...
    return (
        <div>
            <ul data-testid="comments-list" className={styles['post-comments']}>
            ...
            <form onSubmit={handleAddComment} className={styles['post-comments-form']}>
                ...
                <button data-testid="comment-submit-button" type="submit" className={styles['post-comments-form-button']}>
                    Comentar
                </button>
            </form>
        </div>
